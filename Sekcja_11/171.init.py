...
ini = ini_file(r'E:\Python\00 Python_DC\temp\my.ini')
ini.write_parameter('version', 1)
ini.write_parameter('level', 'advanced')
ini.save_on_disk()

ini2 = ini_file(r'E:\Python\00 Python_DC\temp\my.ini')
print(ini2.parameters)
print(ini2.read_parameter('version'))
print(ini2.read_parameter('level'))

with ini_file(r'E:\Python\00 Python_DC\temp\my.ini') as ini3:   # context menager
