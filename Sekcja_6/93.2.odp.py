...
for c in Cake.bakery_offer:
    c.show_info()
# Tworząc obiekty klasy Cake przekaż dodatkowy argument text 
# - umieść napisy puste lub inne typowo  "tortowe", część poprawnych 
# (czyli napis na torcie) i część niepoprawnych (np. napis na waflu) 
