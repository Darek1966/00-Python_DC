# uproszczenie w związku z zastosowaniem property
...
class Car:     
    ...
    def __GetIsOnSale(self):   # znak __ ukryte metody
        return self.__isOnSale

    def __SetIsOnSale(self, newIsOnSaleStatus):   # znak __ ukryte metody
...
'''
print('Czy samochody sa na wyprzedazy:', car_1.__GetIsOnSale(), car_2.__GetIsOnSale())
